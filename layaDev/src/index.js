function layaInit() {
    ...
    Laya.loader.load(PreResources, laya.utils.Handler.create(this, this.preLoadComplate), null);
...
function preLoadComplate() {
    ...
    Laya.loader.load(Resources, laya.utils.Handler.create(this, this.loadUIComplate));
}
